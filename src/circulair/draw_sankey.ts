...
import { Graph, GraphArrow } from './model';

const drawArrow = (arrow: GraphArrow){
    let totalDashArrayLength = arrow.length + arrow.gapLength;
...
export const drawSankey = (graphSetup: Graph) => {
